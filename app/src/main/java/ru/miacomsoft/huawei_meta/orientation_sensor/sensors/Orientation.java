package ru.miacomsoft.huawei_meta.orientation_sensor.sensors;
...
import ru.miacomsoft.huawei_meta.orientation_sensor.math.Matrix3x3;
import ru.miacomsoft.huawei_meta.orientation_sensor.responseProvider.orientationResponseProvider;
...
public class Orientation implements Isensor,Observer {
    ...
    public void on(int speed) {
        ...
        switch (speed){
            case 0:
                fuseTimer.scheduleAtFixedRate(new calculateFusedOrientationTask(),1, 224);
                break;
            case 1:
                fuseTimer.scheduleAtFixedRate(new calculateFusedOrientationTask(),1, 77);
                break;
            case 2:
                fuseTimer.scheduleAtFixedRate(new calculateFusedOrientationTask(),1, 37);
                break;
            default:
                fuseTimer.scheduleAtFixedRate(new calculateFusedOrientationTask(),1, 16);
        }
